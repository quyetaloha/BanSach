...
<body>
			...
			<div class="row s_product_inner">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>${sach.tenSach }</h3>
						<h2>${sach.giaBan } VND</h2>
						<ul class="list">
							<li><a class="active" href="#"><span><h7>Tác giả</h7></span> : ${sach.tacGia }</a></li>
							<li><a href="#"><span><h7>Ngày xuất bản</h7></span> : ${sach.ngayXuatBan }</a></li>
						</ul>
						<h6>${sach.moTa }</h6>
						
						<div class="card_area d-flex align-items-center">
							<a class="primary-btn" href="/BanSach/addToCart/${sach.maSach }">Thêm vào giỏ</a>
	...
	<!--================End Single Product Area =================-->
					...
					<div style="margin-left: 190px;margin-top: 100px" class="table-responsive">
						<table class="table">
							<tbody>
								<tr>
									<td>
								...
								<tr>
									<td>
										<h5>Người biên dịch</h5>
									</td>
									<td>
										<h5>${sach.nguoiBienDich }</h5>
									</td>
								</tr>
								<tr>
									<td>
						...
						<div class="col-lg-6">
							<div class="comment_list">
								<div class="review_item">
									<div class="media">
										<div class="d-flex">
											<img src="<c:url value="/resources/img/product/review-1.png" />" alt="">
										</div>
								...
								<div class="review_item reply">
									<div class="media">
										<div class="d-flex">
											<img src="<c:url value="/resources/img/product/review-2.png" />" alt="">
										</div>
										<div class="media-body">
											<h4>Blake Ruiz</h4>
											<h5>12th Feb, 2018 at 05:56 pm</h5>
								...
								<div class="review_item">
									<div class="media">
										<div class="d-flex">
											<img src="<c:url value="/resources/img/product/review-3.png" />" alt="">
										</div>
										<div class="media-body">
											<h4>Blake Ruiz</h4>
											<h5>12th Feb, 2018 at 05:56 pm</h5>
				...
				<div class="col-lg-3">
					<div class="ctg-right">
						<a href="#" target="_blank">
							<img class="img-fluid d-block mx-auto" src="<c:url value="/resources/img/category/c5.jpg" />" alt="">
						</a>
					</div>
				</div>
			</div>
